...
var idleTime = 7200000; // number of miliseconds until the user is considered idle (Tiempo de Inactividad para activarse = 2 segundos = 2 * 1000.  Ultimo tiempo: 15 ((60 * 60 * 1000) / 4) minutos)
...
var redirectTo = 'Frm_DoLogin.aspx'; // URL to relocate the user to once they have timed out 
var keepAliveURL = 'http://appalma.managua.gob.ni/Medio_Ambiente/App_cliente/Frm_LogOut.aspx'; // URL to call to keep the session alive 
