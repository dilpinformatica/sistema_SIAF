<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="SYS_REG_OPCIONES.aspx.cs" Inherits="SYS_REG_OPCIONES" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    ...
    <script type="module" src="js/Sys_Reg_Opciones.js?v=<% Response.Write(string.Concat(string.Format("{0:dd/MM/yyyy}", DateTime.Now), " ", string.Format("{0:hh:mm:ss}", DateTime.Now))); %>"></script>
    ...
    <div id="Mi_Modelo_Principal" style="width:100%;height:100%;float:left;">
        <div class="row" style="margin-left:0.1%;width:100%; height:auto !important; ">
            <div class="col-sm-12 col-lg-12 col-xs-12 col-md-12" style="text-align:center;">
                <h1 id="cTitulo" class="bTitulos">REGISTRO DE LAS OPCIONES DEL SISTEMA</h1>
            </div>           
        </div>
        ...
        <div class="row" style="margin-left:0.1%;width:100%; height:auto !important; ">
            ...
            <div class="col-sm-2 col-lg-2 col-xs-2 col-md-2">
                <select class="form-control Estilos_Encabezados" spellcheck="false" data-bind="value: ID_Estado, options: lst_Estados, optionsValue: 'ID', optionsText: 'DESCRIPCION', event: { change: load_Datos_ROLES } "></select>
            </div> 
        </div> 
                    ...
                    <table class="table table-bordered table-condensed" style="width:110%; max-width:110%">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:center;vertical-align:middle;width:10%"><strong>COD_01</strong></th>
                                <th style="text-align:center;vertical-align:middle;width:5%"><strong>COD_02</strong></th>
                                <th style="text-align:center;vertical-align:middle;width:20%;"><strong>DESCRIPCION</strong></th>
                                <th style="text-align:center;vertical-align:middle;width:5%;"><strong>NIVEL</strong></th>
                                <th style="text-align:center;vertical-align:middle;width:5%;"><strong>ORDEN</strong></th>
                        ...
                        <tbody data-bind="foreach: g_Paginacion">
                            <tr>
                                ...
                                <td style="display:none;" data-bind="text: ID_NIVEL"></td>
                                <td style="display:none;" data-bind="text: RAYA"></td>
                                <td style="text-align:center;vertical-align:middle;" data-bind="text: CODIGO"></td>
                                <td style="text-align:center;vertical-align:middle;" data-bind="text: CODIGO_01"></td>
                                <td style="text-align:center;vertical-align:middle;" data-bind="text: CODIGO_02"></td>
                                <td style="vertical-align:middle;" data-bind="text: DESCRIPCION"></td>
                                <td style="vertical-align:middle;" data-bind="text: DESC_NIVEL"></td>
                                <td style="text-align:center;vertical-align:middle;" data-bind="text: ORDEN"></td>
    ...
    <div id="Frm_Datos" class="Ventanas">
        <div class="container-fluid">
            <div class="row" style="width:100%;height:100%;padding:0.5em 0.5em 0.5em 0.5em;">
                <label for="txt_codigo_01" class="col-sm-2 col-lg-2 col-xs-2 col-md-2">Código 01:</label> 
                <div class="col-sm-3 col-lg-3 col-xs-3 col-md-3">
                    <input id="Txt_Codigo_01" type="text" class="form-control InputBox" style="font-size:0.9em;color:Maroon;font-weight:bold;text-align:center;" spellcheck="false" title="Código de la Opción (Resumen)..." />
                </div> 
                <label for="txt_nivel" class="col-sm-1 col-lg-1 col-xs-1 col-md-1 yOpt">Nivel:</label> 
                <div class="col-sm-3 col-lg-3 col-xs-3 col-md-3 yOpt">
                    <select id="Cmb_Nivel" class="form-control ComboBox" style="font-size:0.9em;color:Maroon;text-transform:uppercase;font-weight:bold;" spellcheck="false">
                        <option value="1">RESUMEN</option>
                        <option value="2">DETALLE</option>
                    </select>
                </div>
                <div id="xOpt" class="col-sm-3 col-lg-3 col-xs-3 col-md-3">
                    <select id="Txt_Codigo_02" class="form-control" style="font-size:0.9em;color:Maroon;font-weight:bold;" spellcheck="false">
            ...
            <div class="row" style="width:100%;height:100%;padding:0.5em 0.5em 0.5em 0.5em;">
                ...
                <div class="col-sm-6 col-lg-6 col-xs-6 col-md-6">
                    <input id="Txt_Descripcion" type="text" class="form-control InputBox" style="font-size:0.9em;color:Maroon;text-transform:uppercase;font-weight:bold;" maxlength="1000" spellcheck="false"  title="Descripción del Rol..." />
                </div> 
                <div class="col-sm-2 col-lg-2 col-xs-2 col-md-2">
                    <input id="Txt_Orden" type="text" class="form-control InputBox" style="font-size:0.9em;color:Maroon;font-weight:bold;text-align:center;" placeholder="ORDEN" spellcheck="false" title="Orden del Registro..." />
                </div> 
                <div class="col-sm-2 col-lg-2 col-xs-2 col-md-2">
                    <div class="form-check">
                        <label class="form-check-label"><input id="Chk_Raya" class="form-check-input CheckBox" type="checkbox">Raya</label>
                    </div>
                </div>    
            </div>
        </div>
