...
// Variable Global
var xUbica = "", xElem = "", yMetodos = [], xSesion_Prueba = "", yUser = "", xBand_Tipo_Marcas = 0,  xID_TIPO_MARCA = 0, xCODIGO_MARCA = '';
        ...
        try {
            ...
            var xMi_Modelo_01 = function () {
                ...
                self.Agregar_Enc = function () {
                    ...
                    xBand_Tipo_Marcas = 1; xID_TIPO_MARCA = 0;
                ...
                self.Datos_Registros = async ( yESTADO ) => {
                    ...
                    if ((yESTADO == null) || (yESTADO == undefined)) {
                        ...
                        $(".loader").fadeIn("slow");
                        let Mi_url = 'Frm_Metodos_WEB_Services.aspx/Listar_CAT_TIPO_MARCAS';
                ...
                self.selectRow_Editar = function (item) {
                    ...
                    xID_TIPO_MARCA = parseFloat(item.ID); 
                ...
                self.selectRow_Baja = function(item){
                    ...
                    // Se recuperan los Datos...
                    xID_TIPO_MARCA = parseFloat(item.ID); xCODIGO_MARCA = item.CODIGO;
                ...
                self.selectRow_Reactivar = function(item){
                    ...
                    let Reactivar_Registros = async (lID, lUSER, lSESION) => {
                        let Mi_url = "Frm_Metodos_WEB_Services.aspx/Reactivar_CAT_TIPO_MARCAS";
            ...
            $("#Frm_Datos").dialog({
                ...
                closeOnEscape: false,
                open: function () {
                    $(this).dialog('option', 'title', (xBand_Tipo_Marcas == 1) ? 'AGREGAR REGISTRO NUEVO' : 'EDITAR REGISTRO EXISTENTE');

                    if (xBand_Tipo_Marcas == 1) {
                ...
                buttons: [
                {
                    ...
                    click: function () {
                        ...
                        uEncabezado.push({ ID: xID_TIPO_MARCA, DESCRIPCION: xDESC, USER: xUSER });

                        // Ejecutando la Orden
                        let Guardar_Registros = async (yDatos, lSESION) => {
                            let Mi_url = "Frm_Metodos_WEB_Services.aspx/Insertar_Actualizar_CAT_TIPO_MARCAS";
                            ...
                            if (response.d.exito == false){
                                ...
                                xContenido = 'Acción Realizada con Exito...'; yMetodos[1](xContenido, "success"); 
                                xID_TIPO_MARCA = parseFloat(response.d.Mensaje);
            ...
            $("#Frm_Baja").dialog({
                ...
                closeOnEscape: false,
                open: function () {
                    $(this).dialog('option', 'title', 'BAJA AL REGISTRO Nº - ' + xCODIGO_MARCA);
                ...
                buttons: [
                {
                    text: "GUARDAR",
                    click: function () {
                        var xOBS = ($.trim($("#Txt_Observacion_Baja").val()).length == 0) ? "BAJA AL REGISTRO Nº : " + xCODIGO_MARCA : $.trim($("#Txt_Observacion_Baja").val()).toUpperCase();
                        ...
                        let Baja_Registros = async (lID, lFECHA, lOBS, lUSER, lSESION) => {
                            let Mi_url = "Frm_Metodos_WEB_Services.aspx/Baja_CAT_TIPO_MARCAS";
                            ...
                            if (response.d.exito == false){
                                ...
                                // Limpiando Campos...
                                xID_TIPO_MARCA = 0; xCODIGO_MARCA = '';

                                $("#Txt_Fecha_Baja").val(date_str); 
                                $("#Txt_Observacion_Baja").val('');
                            } 
                        };
                        Baja_Registros(xID_TIPO_MARCA, bFECHA_BAJA, xOBS, xUSER, xSESION);
                    },
                    class: "ui-button-spl2"
                },
                {
...
function Configuracion_Inicial() {
    ...
    $("#Opt_01").click();
    $("#Opt_01_02").css({ "background-color": "#F4FA58" });
