...
// Variable Global
var xUbica = "", xElem = "", yMetodos = [], xSesion_Prueba = "", yUser = "", xBand_Cat_Centros_Costos = 0,  xID_CAT_CENTRO_COSTO = 0, xCODIGO_CAT_CENTRO_COSTO = '';
        ...
        try {
            ...
            var xMi_Modelo_01 = function () {
                ...
                self.Agregar_Enc = function () {
                    ...
                    xBand_Cat_Centros_Costos = 1; xID_CAT_CENTRO_COSTO = 0;
                ...
                self.Datos_Registros = async ( yESTADO ) => {
                    ...
                    if ((yESTADO == null) || (yESTADO == undefined)) {
                        ...
                        $(".loader").fadeIn("slow");
                        let Mi_url = 'Frm_Metodos_WEB_Services.aspx/Listar_CAT_CENTROS_COSTOS';
                ...
                self.load_Datos_Centros_Costos = () => {
                ...
                self.selectRow_Editar = function (item) {
                    ...
                    xID_CAT_CENTRO_COSTO = parseFloat(item.ID); 

                    $('#Txt_Descripcion').val(item.DESCRIPCION); 

                    // Se Visualiza el DIV de la Gestión
                    xBand_Cat_Centros_Costos = 2;
                    $('#Frm_Datos').dialog('open');
                };
                ...
                self.selectRow_Baja = function(item){
                    ...
                    // Se recuperan los Datos...
                    xID_CAT_CENTRO_COSTO = parseFloat(item.ID); xCODIGO_CAT_CENTRO_COSTO = item.CODIGO;
                ...
                self.selectRow_Reactivar = function(item){
                    ...
                    let Reactivar_Registros = async (lID, lUSER, lSESION) => {
                        let Mi_url = "Frm_Metodos_WEB_Services.aspx/Reactivar_CAT_CENTRO_COSTOS";
            ...
            $("#Frm_Datos").dialog({
                ...
                closeOnEscape: false,
                open: function () {
                    $(this).dialog('option', 'title', (xBand_Cat_Centros_Costos == 1) ? 'AGREGAR REGISTRO NUEVO' : 'EDITAR REGISTRO EXISTENTE');

                    if (xBand_Cat_Centros_Costos == 1) {
                ...
                buttons: [
                {
                    ...
                    click: function () {
                        ...
                        uEncabezado.push({ ID: xID_CAT_CENTRO_COSTO, DESCRIPCION: xDESC, USER: xUSER });

                        // Ejecutando la Orden
                        let Guardar_Registros = async (yDatos, lSESION) => {
                            let Mi_url = "Frm_Metodos_WEB_Services.aspx/Insertar_Actualizar_CAT_CENTROS_COSTOS";
                            ...
                            if (response.d.exito == false){
                                ...
                                xContenido = 'Acción Realizada con Exito...'; yMetodos[1](xContenido, "success"); 
                                xID_CAT_CENTRO_COSTO = parseFloat(response.d.Mensaje);
            ...
            $("#Frm_Baja").dialog({
                ...
                closeOnEscape: false,
                open: function () {
                    $(this).dialog('option', 'title', 'BAJA AL REGISTRO Nº - ' + xCODIGO_CAT_CENTRO_COSTO);
                ...
                buttons: [
                {
                    text: "GUARDAR",
                    click: function () {
                        var xOBS = ($.trim($("#Txt_Observacion_Baja").val()).length == 0) ? "BAJA AL REGISTRO Nº : " + xCODIGO_CAT_CENTRO_COSTO : $.trim($("#Txt_Observacion_Baja").val()).toUpperCase();
                        ...
                        let Baja_Registros = async (lID, lFECHA, lOBS, lUSER, lSESION) => {
                            let Mi_url = "Frm_Metodos_WEB_Services.aspx/Baja_CAT_CENTROS_COSTOS";
                            ...
                            if (response.d.exito == false){
                                ...
                                // Limpiando Campos...
                                xID_CAT_CENTRO_COSTO = 0; xCODIGO_CAT_CENTRO_COSTO = '';

                                $("#Txt_Fecha_Baja").val(date_str); 
                                $("#Txt_Observacion_Baja").val('');
                            } 
                        };
                        Baja_Registros(xID_CAT_CENTRO_COSTO, bFECHA_BAJA, xOBS, xUSER, xSESION);
                    },
                    class: "ui-button-spl2"
                },
                {
...
function Configuracion_Inicial() {
    ...
    $("#Opt_01").click();
    $("#Opt_01_11").css({ "background-color": "#F4FA58" });
