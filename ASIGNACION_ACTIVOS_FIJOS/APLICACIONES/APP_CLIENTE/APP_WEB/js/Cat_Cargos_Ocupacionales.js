...
// Variable Global
var xUbica = "", xElem = "", yMetodos = [], xSesion_Prueba = "", yUser = "", xBand_Cargos_Ocupacionales = 0,  xID_CARGOS = 0, xCODIGO_CARGOS = '';
        ...
        try {
            ...
            var xMi_Modelo_01 = function () {
                ...
                self.Agregar_Enc = function () {
                    ...
                    xBand_Cargos_Ocupacionales = 1; xID_CARGOS = 0;
                ...
                self.Datos_Registros = async ( yESTADO ) => {
                    ...
                    if ((yESTADO == null) || (yESTADO == undefined)) {
                        ...
                        $(".loader").fadeIn("slow");
                        let Mi_url = 'Frm_Metodos_WEB_Services.aspx/Listar_CAT_CARGOS_OCUPACIONAL';
                ...
                self.load_Datos_Cargos_Ocupacionales = () => {
                ...
                self.selectRow_Editar = function (item) {
                    ...
                    xID_CARGOS = parseFloat(item.ID); 

                    $('#Txt_Descripcion').val(item.DESCRIPCION); 

                    // Se Visualiza el DIV de la Gestión
                    xBand_Cargos_Ocupacionales = 2;
                    $('#Frm_Datos').dialog('open');
                };
                ...
                self.selectRow_Baja = function(item){
                    ...
                    // Se recuperan los Datos...
                    xID_CARGOS = parseFloat(item.ID); xCODIGO_CARGOS = item.CODIGO;
            ...
            $("#Frm_Datos").dialog({
                ...
                closeOnEscape: false,
                open: function () {
                    $(this).dialog('option', 'title', (xBand_Cargos_Ocupacionales == 1) ? 'AGREGAR REGISTRO NUEVO' : 'EDITAR REGISTRO EXISTENTE');

                    if (xBand_Cargos_Ocupacionales == 1) {
                ...
                buttons: [
                {
                    ...
                    click: function () {
                        ...
                        uEncabezado.push({ ID: xID_CARGOS, DESCRIPCION: xDESC, USER: xUSER });

                        // Ejecutando la Orden
                        let Guardar_Registros = async (yDatos, lSESION) => {
                            let Mi_url = "Frm_Metodos_WEB_Services.aspx/Insertar_Actualizar_CAT_CARGOS_OCUPACIONAL";
                            ...
                            if (response.d.exito == false){
                                ...
                                xContenido = 'Acción Realizada con Exito...'; yMetodos[1](xContenido, "success"); 
                                xID_CARGOS = parseFloat(response.d.Mensaje);
            ...
            $("#Frm_Baja").dialog({
                ...
                closeOnEscape: false,
                open: function () {
                    $(this).dialog('option', 'title', 'BAJA AL REGISTRO Nº - ' + xCODIGO_CARGOS);
                ...
                buttons: [
                {
                    text: "GUARDAR",
                    click: function () {
                        var xOBS = ($.trim($("#Txt_Observacion_Baja").val()).length == 0) ? "BAJA AL REGISTRO Nº : " + xCODIGO_CARGOS : $.trim($("#Txt_Observacion_Baja").val()).toUpperCase();
                        ...
                        let Baja_Registros = async (lID, lFECHA, lOBS, lUSER, lSESION) => {
                            let Mi_url = "Frm_Metodos_WEB_Services.aspx/Baja_CAT_CARGOS_OCUPACIONAL";
                            ...
                            if (response.d.exito == false){
                                ...
                                // Limpiando Campos...
                                xID_CARGOS = 0; xCODIGO_CARGOS = '';

                                $("#Txt_Fecha_Baja").val(date_str); 
                                $("#Txt_Observacion_Baja").val('');
                            } 
                        };
                        Baja_Registros(xID_CARGOS, bFECHA_BAJA, xOBS, xUSER, xSESION);
                    },
                    class: "ui-button-spl2"
                },
                {
...
function Configuracion_Inicial() {
    ...
    $("#Opt_01").click();
    $("#Opt_01_12").css({ "background-color": "#F4FA58" });
